...
const IsiProfile = ({ isAnimated }: booleanProps) => {
  ...
  return !hideDiv ? (
        ...
        <div className="flex flex-col ml-10 mt-5">
          <div className="flex flex-row gap-2 relative">
            <img
              ...
              alt=""
            />
            <span className="font-[700] text-[#57C5B6] text-[30px]">About</span>
            <span className="font-[700] z-20 text-zinc-200 text-[30px]">
              Me
            </span>
          </div>
          <div className="flex flex-row gap-20">
            <span className="font-[500] w-[50%] xl:text-[16px] lg:text-[14px] text-[14px] text-zinc-200">
              my name is Yanson. I am a graduate of Bunda Mulia University
              majoring in Informatics. Currently, I have experience as a
              Frontend Developer. Some of the programming languages that I have
              mastered include TypeScript, Next.Js, React.JS, and React Native.
              As for CSS, I am proficient in using Tailwind CSS to create
              website user interfaces and Native Base for React Native (Mobile)
              projects.
            </span>
          ...
          <div className="flex mt-10 flex-row relative">
            <img
              ...
              alt=""
            />
            <span className="font-[700] text-[#57C5B6] text-[30px]">Educa</span>
            <span className="font-[700] z-20 text-zinc-200 text-[30px]">
              tion
            </span>
          </div>
          ...
          <div className="flex mt-10 flex-row relative">
            <img
              ...
              alt=""
            />
            <span className="font-[700] text-[#57C5B6] text-[30px]">Exper</span>
            <span className="font-[700] z-20 text-zinc-200 text-[30px]">
              ience
            </span>
          </div>
                    ...
                    <ol className="dark:border-[#57C5B6] ml-4">
                      <li>
                        ...
                        <div className="flex-start flex items-center pt-3">
                          <div className="-ml-[5px] mr-3 h-[5px] w-[5px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]"></div>
                          <p className="text-sm text-zinc-200 font-[600]">
                            Creating a Website Dashboard Page based on JSON Data
                            from Backend
                          </p>
                        </div>
                        <div className="flex-start flex items-center pt-3">
                        ...
                        <div className="flex-start flex items-center pt-3">
                          <div className="-ml-[5px] mr-3 h-[5px] w-[5px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]"></div>
                          <p className="text-sm text-zinc-200 font-[600]">
                            Using Responsive Design in Creating User Interfaces
                    ...
                    <ol className="dark:border-[#57C5B6] ml-4">
                      <li>
                        ...
                        <div className="flex-start flex items-center pt-3">
                          <div className="-ml-[5px] mr-3 h-[5px] w-[5px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]"></div>
                          <p className="text-sm text-zinc-200 font-[600]">
                            process voucher payment Salary, BPJS, and Jamsostek
                          </p>
                        </div>
                        <div className="flex-start flex items-center pt-3">
                          <div className="-ml-[5px] mr-3 h-[5px] w-[5px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]"></div>
    ...
    <>
      {/* responsive active */}
      <div
        className={`mt-10 h-screen bg-[#0A2647] ${
          isAnimated
            ? "animate__animated animate__fadeInDown animate__fast animate__delay-1s"
            : `animate__animated animate__fadeOutUp animate__fast`
        }  h-max-screen overflow-y-scroll rounded-[40px]`}
      >
        <div className="flex flex-col ml-10 mt-5 w-full">
          ...
          <div className="flex flex-col gap-5">
            <span className="font-[500] w- mr-14 xl:text-[16px] lg:text-[14px] text-[14px] text-zinc-200">
              my name is Yanson. I am a graduate of Bunda Mulia University
              majoring in Informatics. Currently, I have experience as a
              Frontend Developer. Some of the programming languages that I have
              mastered include TypeScript, Next.Js, React.JS, and React Native.
            ...
            <div className="flex flex-col mr-14 gap-1">
              <div className="flex md:flex-row sm:flex-row flex-col gap-2">
                <span className="font-[500] text-[16px] text-[#57C5B6]">
                  Date / Place of birth
                </span>
                <span className="font-[500] text-[16px] text-zinc-200">
            ...
            <div className="flex ml-7 items-center">
              <ol className="dark:border-[#57C5B6]">
                <li>
                  ...
                  <div className="flex-start flex items-center pt-3">
                    <div className="-ml-[5px] mr-3 h-[11px] w-[11px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]"></div>
                    <p className="text-sm text-zinc-200 font-[600]">Next.JS</p>
                  </div>
                  <div className="flex-start flex items-center pt-3">
                    <div className="-ml-[5px] mr-3 h-[11px] w-[11px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]"></div>
                    <p className="text-sm text-zinc-200 font-[600]">
                  ...
                  <div className="flex-start flex items-center pt-3">
                    <div className="-ml-[5px] mr-3 h-[11px] w-[11px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]"></div>
                    <p className="text-sm text-zinc-200 font-[600]">React.JS</p>
                  </div>
                  <div className="flex-start flex items-center pt-3">
                    <div className="-ml-[5px] mr-3 h-[11px] w-[11px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]"></div>
                    <p className="text-sm text-zinc-200 font-[600]">
          ...
          <div className="flex flex-row gap-20">
            <div className="w-[50%]">
              <ol className="border-l border-neutral-300 dark:border-[#57C5B6]">
                <li>
                  <div className="flex-start flex items-center pt-3">
                    <div className="-ml-[6px] animate-bounce mr-3 h-[11px] w-[15px] rounded-full bg-[#57C5B6] dark:bg-[#57C5B6]" />
                    <p className="text-sm text-zinc-200 font-[600]">
                      2018 - 2022 Universitas Bunda Mulia
                    </p>
                  </div>
